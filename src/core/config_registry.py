...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "ALPHASIFT_ENABLED": {
        ...
        "description": "Enable the built-in AlphaSift stock screening service. Enabled by default; an explicit false disables screening while keeping the navigation entry visible for status and recovery guidance. This switch only affects the AlphaSift screening path; it does not migrate, sanitize, or clear existing LLM/runtime fields in `.env`.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "ALPHASIFT_ENRICHMENT_MAX_WORKERS": {
        "title": "AlphaSift Enrichment Concurrency",
        "description": "Maximum concurrent Top-candidate enrichment workers. Set to 1 to restore serial enrichment.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 18,
        "help_key": "settings.data_source.ALPHASIFT_ENRICHMENT_MAX_WORKERS",
        "examples": [
            "ALPHASIFT_ENRICHMENT_MAX_WORKERS=1",
            "ALPHASIFT_ENRICHMENT_MAX_WORKERS=3",
        ],
        "docs": [
            {
                "label": "AlphaSift 集成说明",
